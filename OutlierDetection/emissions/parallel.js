...
d3.csv("emissions_feature_data.csv", function(raw_data) {
...
function render() {
    ...
    d3version5.csv("emissions_rank_data.csv").then(ranks => {
        d3version5.csv("emissions_ts.csv").then(function (data) {
