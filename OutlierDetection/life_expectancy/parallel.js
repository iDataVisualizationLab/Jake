...
d3.csv("life_expectancy_feature_data.csv", function(raw_data) {
...
function render() {
    ...
    d3version5.csv("life_expectancy_rank_data.csv").then(ranks => {
        d3version5.csv("life_expectancy_ts.csv").then(function (data) {
