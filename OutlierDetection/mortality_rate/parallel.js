...
d3.csv("mortality_features1.csv", function(raw_data) {
...
function render() {
    ...
    d3version5.csv("mortality_rankings.csv").then(ranks => {
        d3version5.csv("mortality_ts.csv").then(function (data) {
