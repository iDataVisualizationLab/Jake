...
function start_download() {
    ...
    function download_all_data(alpha, seconds_limit) {
        ...
        get_hull_data(delaunay_container, combinations, alpha, 100, delaunay_properties_container).then(async function (d) {
            ...
            let workers = new Array(combinations.length).fill(new Worker('js/main_matrix_download_data_2-profiles_worker.js'))
            ...
            let timer_worker = new Worker('js/main_matrix_download_data_2-profiles_worker-timer.js')
