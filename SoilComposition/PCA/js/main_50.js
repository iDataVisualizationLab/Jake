...
export function initBuild(_profiles, chemical, valueMin, valueMax){
    ...
    //scene = document.querySelector('#mainScene').object3D;
    //var gSel = scene.getObjectByName("sceneGroup")
    //console.log(scene.getObjectByName("sceneGroup"))

    // for( var i = gSel.children.length - 1; i >= 0; i--) {
    //      var obj = gSel.children[i];
    //      gSel.remove(obj);
    //  }
    // if (points){
    //     //scene.remove(points)
    //     //scene.remove( line )
    //     //document.querySelector('.graduation').remove();
    //     //document.querySelector('.graduation2').remove();
    //     //document.querySelector('.image').remove();
    //     //console.log(  document.getElementsByClassName("graduation"));
    //
    //     //console.log (sceneEl.querySelectorAll(".graduation").item());
    //
...
export async function build(profile, chemical, valueMin, valueMax, xOffset){
    ...
    // label.setAttribute("value", "TRY");
    // label.setAttribute("position", (0+xOffset).toString()+" 70 0");
    // label.setAttribute("scale","2 2 1")
    ...
    //points.setAttribute('position', '0,0,0')
    ...
    // var html = document.getElementById("volume").innerHTML;
...
// var app = document.getElementById('volume')
// doc.open();
// doc.append(app);
// //doc.write('Test');
// doc.close();