        ...
        var b = d3.selectAll('.dimension')[0]
            .forEach(function (element, i) {
                ...
                if (_.include(actives, dimension)) {
                    ...
                    let elem = dimension.split(" ")[0]
                    let vmin = ((extent[0] - dimObject[dimension]['min']) / (dimObject[dimension]['max'] - dimObject[dimension]['min']));
                    let vmax =((extent[1] - dimObject[dimension]['min']) / (dimObject[dimension]['max'] - dimObject[dimension]['min']));
